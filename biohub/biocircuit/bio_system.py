...
def simulate(dict_data):
    ...
    in_file.close()
    os.system('pypy bio_system_old.py<' + temp1 + ' >' + temp2)
    os.system('pypy BioBLESS/biosys/bio_system_old.py<' + temp1 + ' >' + temp2)
    os.system('pypy backend/BioBLESS/biosys/bio_system_old.py<' + temp1 + ' >' + temp2)
